...
export interface ApiChecklistTaskChecklistTask
  ...
  info: {
    description: 'Tarea independiente del Daily Checklist.';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentShift: Schema.Attribute.Enumeration<
      ['servicio', 'producci\u00F3n', 'servicio y producci\u00F3n']
    >;
    frecuency: Schema.Attribute.Enumeration<['weekly', 'biweekly', 'monthly']>;
    interval: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    lastDone: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    previousShift: Schema.Attribute.Enumeration<
      ['servicio', 'producci\u00F3n', 'servicio y producci\u00F3n']
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'hoy'>;
    taskType: Schema.Attribute.Enumeration<['interval', 'weekdays']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'interval'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weekdays: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 7;
          min: 1;
...
export interface ApiDesayunosSliderDesayunosSlider
  ...
  info: {
    description: '';
    displayName: 'DesayunosSlider';
    pluralName: 'desayunos-sliders';
    singularName: 'desayunos-slider';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::desayunos-slider.desayunos-slider'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceCombo: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPurchaseItemPurchaseItem
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enabledCosting: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSandwichesSliderSandwichesSlider
  ...
  info: {
    displayName: 'SandwichesSlider';
    pluralName: 'sandwiches-sliders';
    singularName: 'sandwiches-slider';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sandwiches-slider.sandwiches-slider'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    showinCompras: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
